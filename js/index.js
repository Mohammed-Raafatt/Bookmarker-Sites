...
function addSites(){
    if(bookmarkName.classList.contains("is-valid")&&siteUrl.classList.contains("is-valid")){
...
function display(){
    ...
    for(var i=0;i<siteList.length;i++){
        cartona+=`<tr>
                    ...
                    <td><button onclick="visitSite('${siteList[i].sUrl}')" class="btn btn-outline-primary"><i class="fa-solid fa-eye pe-2"></i>Visit</button></td>
